...
variable "api_image" {
  ...
  type        = string
  default     = "us-central1-docker.pkg.dev/pullsense-staging/pullsense-staging-repo/pullsense-api:latest"
}

variable "client_image" {
  description = "Initial Docker image for Next.js Client"
  type        = string
  default     = "us-central1-docker.pkg.dev/pullsense-staging/pullsense-staging-repo/pullsense-client:latest"
}
